...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void findViews() {
        ...
        mBtnSendDanmaku = (Button) findViewById(R.id.btn_send_text);
        mBtnSendDanmakuTextAndImage = (Button) findViewById(R.id.btn_send_image_text);
        mBtnSendDanmakus = (Button) findViewById(R.id.btn_regularly_send);
        ...
        // VideoView
        VideoView mVideoView = (VideoView) findViewById(R.id.vv_video);
        // DanmakuView
